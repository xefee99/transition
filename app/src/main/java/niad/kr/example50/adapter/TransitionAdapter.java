...
public class TransitionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final static String TAG = TransitionAdapter.class.getSimpleName();
    ...
    public TransitionAdapter(Context context, int layoutId, List<Friend> items, RecyclerView recyclerView) {
