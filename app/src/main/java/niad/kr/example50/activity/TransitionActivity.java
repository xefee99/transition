...
import niad.kr.example50.adapter.TransitionAdapter;
import niad.kr.example50.data.Friend;
import niad.kr.example50.manager.FriendManager;

public class TransitionActivity extends AppCompatActivity implements FriendCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new TransitionAdapter(this, R.layout.item_friend, new ArrayList<Friend>(), recyclerView);
